...
<div class="col-sm-6">
		<form class="form-inline" action="admin/user/find.htm" method="get">
			<div class="form-group mx-sm-3 mb-2">
				...
				<input type="text" class="form-control" name="search" id="inputPassword2" 
				...
				<tr>
					...
					<td>
						<button class="btn btn-primary"
							onclick="window.location.href='admin/user/update-user.htm?username=${user.username}'">
...
function deleteUser(username) {
	Swal.fire({
        ...
        if (result.value) {
        	window.location.href = "user/delete/"+username.trim()+".htm";
