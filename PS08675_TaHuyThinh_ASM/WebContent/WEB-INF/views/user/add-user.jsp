...
<body>
	<div class="container-fluid d-flex justify-content-center">
		<div
			...
			<form method="post" action="admin/user/add-user.htm" name="submitForm"
				...
				<div class="form-group my-3 text-center" data-plugin="formMaterial">
					<h3><s:message code="staff.insert"/></h3>
				</div>
				...
				<div class="form-group my-3" data-plugin="formMaterial">
					...
					<input type="text" class="form-control validated"
						id="inputFullname" name="fullName" placeholder="Full name" required>
					<div class="invalid-feedback">Invalid Fullname</div>
				</div>
				<button class="btn btn-primary mb-3" type="submit"><s:message code="staff.insert"/></button>
